...
-- Metadata from .tiles file for BaseTeleporter
-- BlocksPlacement = True
-- CanScrap = True
-- ContainerCapacity = 500
-- ContainerType = BaseTeleporter
-- CustomName = Base Teleporter
-- IsMoveAble = True
-- PickUpLevel = 2
-- PickUpTool = Electrician
-- PickUpWeight = 200
-- PlaceTool = Electrician
-- TileBlockStyle = SolidTransparent
-- solidtrans =

-- gid 1000 (does this matter or is it autogenerated?)
